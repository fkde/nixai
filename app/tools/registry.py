...
def _workspace_definitions() -> list[ToolDefinition]:
    return [
        ToolDefinition(
...
def _git_definitions() -> list[ToolDefinition]:
    return [
        ToolDefinition(
...
def _shell_definitions() -> list[ToolDefinition]:
    return [
        ToolDefinition(
...
def _notification_definitions() -> list[ToolDefinition]:
    return [
        ToolDefinition(
...
def _internet_definitions() -> list[ToolDefinition]:
    return [
        ToolDefinition(
...
def _tool_search_definitions(handler: ToolHandler) -> list[ToolDefinition]:
    return [
        ToolDefinition(
...
class ToolRegistry:
    ...
    def _base_definitions(self) -> list[ToolDefinition]:
        return [
            ...
            *_internet_definitions(),
            *_tool_search_definitions(self._search_tool),
        ]
