...
.PHONY: help install install-desktop install-editable install-editable-desktop serve desktop desktop-check check check-python check-js diff-check build build-cli build-macos-app verify-macos-app install-macos-app clean
